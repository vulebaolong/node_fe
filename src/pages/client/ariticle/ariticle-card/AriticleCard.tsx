...
import classes from "./AriticleCard.module.css";
...
export function ArticleCard() {
   ...
   return (
      <Card withBorder radius="md" className={classes.card}>
         <Card.Section>
            <a {...linkProps}>
               <Image src="https://i.imgur.com/Cij5vdL.png" height={180} alt="img" />
            </a>
         </Card.Section>
         ...
         <Text fz="sm" c="dimmed" lineClamp={4}>
            ...
            fighting against various mutated zombies, you’re now dealing with more occult enemies
